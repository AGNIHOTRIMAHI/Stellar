  ...
  return (
    <nav className="bg-black text-gray-200 flex justify-between items-center p-4 h-20 text-sm md:text-[15px] font-medium text-nowrap">
      ...
      <ul className="hidden xl:flex space-x-6">
        ...
        <li className="cursor-pointer hover:text-[#bc2ddc]">Tv Shows</li>
        <li className="cursor-pointer hover:text-[#bc2ddc]">Movies</li>
        <li className="cursor-pointer hover:text-[#bc2ddc]">Anime</li>
        <li className="cursor-pointer hover:text-[#bc2ddc]">Games</li>
        <li className="cursor-pointer hover:text-[#bc2ddc]">New & Popular</li>
        <li className="cursor-pointer hover:text-[#bc2ddc]">Upcoming</li>
      </ul>
      ...
      <div className="flex items-center space-x-4 relative">
        <div className="relative hidden md:inline-flex">
          <input
            type="text"
            className="bg-[#300654] px-4 py-2 rounded-full min-w-72 pr-10 outline-none"
            placeholder="Search..."
          />
        ...
        <Link to={user ? "ai-recommendations" : "signin"}>
          <button className="bg-[#890bab] px-5 py-2 text-white cursor-pointer">
            Get AI Movie Picks
          </button>
        </Link>
